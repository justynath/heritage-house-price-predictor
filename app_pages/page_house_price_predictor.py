...
def page_house_price_predictor_body():
    ...
    st.info(
        "Input house features below to predict the sale price. "
    ...
    X_live['GrLivArea'] = col1.number_input(
        "Above Grade Living Area", 300, 6000, 1500)
    X_live['OverallQual'] = col2.slider("Overall Quality (1–10)", 1, 10, 6)
    X_live['TotalBsmtSF'] = col1.number_input(
        "Total Basement SF", 1, 3000, 900)
