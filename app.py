...
st.set_page_config(
    page_title="Heritage House Price Predictor",
    page_icon="🏠"
)
# Load page scripts
from app_pages.multipage import MultiPage
from app_pages.page_data_study import page_data_study_body
from app_pages.page_house_price_predictor import (
    page_house_price_predictor_body)
from app_pages.page_hypothesis_and_validation import (
    page_hypothesis_and_validation_body)
